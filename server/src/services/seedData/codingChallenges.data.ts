export const rawCodingChallenges = [
  {
...
fun CounterApp() {
    ...
    explanation:
      'This challenge tests your understanding of Compose state management. The key is using `remember` with `mutableStateOf` to create state that triggers recomposition.',
    testCases: [
...
class ProfileViewModel : ViewModel() {
    ...
    explanation:
      'ViewModels separate UI logic from business logic. StateFlow is the modern way to expose reactive state from a ViewModel.',
    testCases: [
...
`,
    ...
    explanation:
      'Pandas is the foundation of data science in Python. These operations — creating DataFrames, aggregating, filtering — are used daily.',
    testCases: [
...
export default function TodoApp() {
  ...
  return (
    ...
    explanation:
      'This tests your understanding of React state management, event handling, and list rendering with keys.',
    testCases: [
